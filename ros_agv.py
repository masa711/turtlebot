...
class Joy():
    ...
    def get_stick(self):
        result = {
            ...
            "joy_lt": self.map_axis(self.joystick.get_axis(2)),
            "joy_rx": -self.map_axis(self.joystick.get_axis(3)),
            "joy_ry": self.map_axis_t(self.joystick.get_axis(4)),
            ...
            "btn_guide": self.joystick.get_button(8),
            "btn_joyl": self.joystick.get_button(9),
            "btn_joyr": self.joystick.get_button(10),
        }
...
def main():
    ...
    rospy.init_node("ros_agv", anonymous=True)    # 上位ノード作成
